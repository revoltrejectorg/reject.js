...
export class Member extends baseClass {
  ...
  get client() { return this.revoltMember.client; }
  ...
  get guild() { if (this.revoltMember.server) return new Guild(this.revoltMember.server); return; }
  ...
  get user() { if (this.revoltMember.user) return new User(this.revoltMember.user); return undefined; }
